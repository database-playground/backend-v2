...
func PrometheusMetrics(entClient *ent.Client, lifecycle fx.Lifecycle) prometheus.Gatherer {
...
func PrometheusHTTPHandler(cfg config.Config, gatherer prometheus.Gatherer, lifecycle fx.Lifecycle) {
